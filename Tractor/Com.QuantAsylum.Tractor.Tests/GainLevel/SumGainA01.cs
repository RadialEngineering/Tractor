...
namespace Com.QuantAsylum.Tractor.Tests.GainTests
{
    ...
    /// </summary>
    [Serializable]
    public class SumGainA01 : SumSplitBase
    {
        ...
        {
            return "Measures the gain of one QA401 input at a specified frequency and amplitude based on the input of both Left and Right QA401 output channels. Results must be within a given window to pass.";
        }
